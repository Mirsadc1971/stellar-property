...
export default function Wrigleyville() {
  return (
    <NeighborhoodLayout
      ...
      metaDescription="Expert property management services in Wrigleyville, Chicago's iconic baseball neighborhood. Manage369 offers professional property management for residential and commercial properties."
