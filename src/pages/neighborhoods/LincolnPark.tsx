...
export default function LincolnPark() {
  return (
    <NeighborhoodLayout
      ...
      metaDescription="Expert property management services in Lincoln Park, Chicago's prestigious lakefront neighborhood. Manage369 offers professional property management for residential and commercial properties."
