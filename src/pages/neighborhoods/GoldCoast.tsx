...
export default function GoldCoast() {
  return (
    <NeighborhoodLayout
      ...
      metaDescription="Expert property management services in Gold Coast, Chicago's prestigious lakefront neighborhood. Manage369 offers professional property management for residential and commercial properties in this historic area."
