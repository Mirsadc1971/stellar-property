...
export default function WestLoop() {
  return (
    <NeighborhoodLayout
      ...
      metaDescription="Expert property management services in West Loop, Chicago's trendy dining and tech hub. Stellar Property Management offers professional property management for residential and commercial properties in this vibrant neighborhood."
