...
export default function RiverNorth() {
  return (
    <NeighborhoodLayout
      ...
      metaDescription="Expert property management services in River North, Chicago's premier arts and entertainment district. Manage369 offers professional property management for residential and commercial properties in this vibrant neighborhood."
