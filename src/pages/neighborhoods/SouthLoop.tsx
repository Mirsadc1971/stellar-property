...
export default function SouthLoop() {
  return (
    <NeighborhoodLayout
      ...
      metaDescription="Expert property management services in South Loop, Chicago's vibrant lakefront community. Stellar Property Management offers professional property management for residential and commercial properties in this dynamic neighborhood."
