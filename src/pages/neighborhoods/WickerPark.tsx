...
export default function WickerPark() {
  return (
    <NeighborhoodLayout
      ...
      metaDescription="Expert property management services in Wicker Park, Chicago's trendy and artistic neighborhood. Manage369 offers professional property management for residential and commercial properties."
